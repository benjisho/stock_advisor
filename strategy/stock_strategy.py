...
def recommend_action(data):
    ...
    data['EMA_12'] = exponential_moving_average(data, 12)
    data['EMA_26'] = exponential_moving_average(data, 26)

    # Define a simple strategy (e.g., buy if 20-day SMA crosses above 50-day SMA, and EMA_12 crosses above EMA_26)
